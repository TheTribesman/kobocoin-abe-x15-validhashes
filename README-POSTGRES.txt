...
Choose or create a system account to run Kobocoin-Abe.  Replace USER with its
...
Perform the initial data load:
    ...
    python -m Kobocoin-Abe.abe --config abe-pg.conf --commit-bytes 100000 --no-serve
...
Then run the web server as:
    ...
    python -m Kobocoin-Abe.abe --config abe-pg.conf
