...
command displays the correct value:
    ...
    python -m Kobocoin-Abe.abe --print-htdocs-directory
...
/home/USER/Kobocoin-Abe/abe-my.conf or change the location below.  See the sample
abe-my.conf in the Abe distribution for file format.  IMPORTANT: Make
sure the configuration does NOT contain a "host" or "port" option.

Create file /home/USER/cgi-bin/abe with these contents:

    #! /bin/sh
    PYTHONUNBUFFERED=1 exec python -m Kobocoin-Abe.abe \
    --config /home/USER/Kobocoin-Abe/abe-my.conf --static-path static/ --watch-pid="$1"
