...
ABE_APPNAME = "KOBO Abe"
ABE_VERSION = __version__
ABE_URL = 'https://github.com/machado-rev/KobocoinExplorer.git'
...
<body>
    <section id="main">
    <a href="http://dns1.kobocoin.com" title="Go back to the Kobocoin Explorer home">
...
class Abe:
    ...
    def handle_chain(abe, page):
        ...
        if hi is None:
            if orig_hi is None and count > 0:
                ...
                body += ['<p class="error">'
                         'The requested range contains no explorer.</p>\n']
            return
    ...
    ''' Kobocoin has two difficulties and we don't have the capability to distinguish them
    ...
    def q_nethash(abe, page, chain):
        ...
        if chain is None:
            return 'Shows statistics every INTERVAL explorer.\n' \
