...
execfile("Kobocoin-Abe/version.py")

setup(
    name         = "Kobocoin-Abe",
    version      = __version__,
    requires     = ['Crypto.Hash'],
    packages     = ["Kobocoin-Abe"],
    package_data = {'Kobocoin-Abe': ['htdocs/*']},
    author       = "Peter Bushnell",
    author_email = "bushsolo@gmail.com",
    url          = "https://github.com/machado-rev/KobocoinExplorer",
    classifiers=[
